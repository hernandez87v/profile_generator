  ...
  rl.question(`What's an activity you like doing? `, answer => {
    ...
    rl.question(`What do you listen to while doing that? `, answer => {
      ...
      rl.question(`Which meal is you favourite? `, answer => {
        ...
        rl.question(
          `What's your favourite thing to eat for ${answers.favMeal}? `,
          answer => {
            ...
            rl.question(`Which sport is your absolute favourite? `, answer => {
              ...
              rl.question(`What is your superpower? `, answer => {
                ...
                console.log(
                  `${answers.name} loves listening to ${answers.music} while ${answers.activity}, devouring ${answers.favFood} for ${answers.favMeal}, prefers ${answers.sport} over any other sport, and is amazing at ${answers.superpower}.`
                );
                rl.close();
              });
            });
